# CoffeeScript App Skeleton for use with [Brunch](http://brunch.io/)
...
Run `brunch new <app> -s https://github.com/damassi/Coffeescript-App-Skeleton` & `brunch build`.  To continually watch for changes, use `brunch watch`.
